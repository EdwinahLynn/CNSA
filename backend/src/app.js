...
app.use('/api/high-schools',          asyncSafe(require('./routes/highSchools')));
app.use('/api/provincial-orgs',       asyncSafe(require('./routes/provincialOrgs')));
app.use('/api/recruiting-incidents',  asyncSafe(require('./routes/recruitingIncidents')));
app.use('/api/recruiting-rankings',   asyncSafe(require('./routes/recruitingRankings')));
